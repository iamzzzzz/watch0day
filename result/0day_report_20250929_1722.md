...
美国网络安全和基础设施安全局（CISA）周四发布了两套恶意软件的详细信息，这些恶意软件是在Ivanti Endpoint Manager中剥削安全缺陷后在一个未命名的组织网络中发现的，这些详细信息是在ivanti Endpoint Manager中发现的。
